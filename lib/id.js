...
var ref = require('@ammora/ref');
var Struct = require('@ammora/ref-struct');
var createFunction = require('@ammora/function-class');
var invoke = require('@ammora/function-class/invoke');
